...
//void LCD_DrawBlock(uint16_t x, uint16_t y, uint16_t fillColor,uint16_t borderColor)
//{
//    /* Fill */
//		LCD_FillRect(x+2, y+1, 8, 8, fillColor);
...
//    );
//}
void LCD_DrawBlock(uint16_t x, uint16_t y,
                   uint16_t fillColor,
                   uint16_t borderColor)
{
    /* Fill */
    LCD_FillRect(x+1, y+1, 10-1, 10-1, fillColor);

    /* Border */
    LCD_DrawRect(x, y, 10, 10, borderColor);
}
/*********************************************************************************************************
      END FILE
*********************************************************************************************************/
