# 1 "Source/Src/IRQ_RIT.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 379 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Source/Src/IRQ_RIT.c" 2
# 10 "Source/Src/IRQ_RIT.c"
...
# 12 "Source/Src/IRQ_RIT.c" 2
# 1 "Source/Src/../Main.h" 1
...
# 5 "Source/Src/../Main.h" 2
# 1 "./Source/Inc\\joystick.h" 1
# 12 "./Source/Inc\\joystick.h"
void joystick_init(void);
# 6 "Source/Src/../Main.h" 2

# 1 "./Source/Inc\\adc.h" 1
...
# 8 "Source/Src/../Main.h" 2
# 1 "./Source/Inc\\GLCD.h" 1
# 90 "./Source/Inc\\GLCD.h"
...
# 9 "Source/Src/../Main.h" 2
# 1 "./Source/Inc\\TouchPanel.h" 1
# 30 "./Source/Inc\\TouchPanel.h"
...
# 10 "Source/Src/../Main.h" 2
# 1 "./Source/Inc\\DAC.h" 1

void DAC_init(void);
void DAC_write(uint16_t value);
# 11 "Source/Src/../Main.h" 2
...
# 11 "Source/Src/../Main.h" 2
# 13 "Source/Src/IRQ_RIT.c" 2
# 22 "Source/Src/IRQ_RIT.c"
void RIT_IRQHandler (void)
{
  if((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOPIN & (1<<25)) == 0){ //sel
  }
  if((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOPIN & (1<<26)) == 0){ //down
  }
  if((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOPIN & (1<<27)) == 0){ //left
  }
  if((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOPIN & (1<<28)) == 0){ //right
  }
  if((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOPIN & (1<<29)) == 0){ //up
  }
