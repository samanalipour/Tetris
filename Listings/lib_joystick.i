# 1 "Source/Src/lib_joystick.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 379 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Source/Src/lib_joystick.c" 2
# 11 "Source/Src/lib_joystick.c"
...
# 12 "Source/Src/lib_joystick.c" 2
# 1 "./Source/Inc\\joystick.h" 1
# 12 "./Source/Inc\\joystick.h"
void joystick_init(void);
# 13 "Source/Src/lib_joystick.c" 2
...
void joystick_init(void) {
  ...
  ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL3 &= ~(0x3FF<<18);
 ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIODIR &= ~(0x1F<<25);
}
