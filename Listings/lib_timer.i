# 1 "Source/Src/lib_timer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 379 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Source/Src/lib_timer.c" 2
# 10 "Source/Src/lib_timer.c"
...
# 106 "C:/Users/saman/AppData/Local/Arm/Packs/Keil/LPC1700_DFP/2.7.2/Device/Include\\LPC17xx.h"
...
# 107 "C:/Users/saman/AppData/Local/Arm/Packs/Keil/LPC1700_DFP/2.7.2/Device/Include\\LPC17xx.h" 2
# 1 "C:/Users/saman/AppData/Local/Arm/Packs/Keil/LPC1700_DFP/2.7.2/Device/Include/system_LPC17xx.h" 1
# 49 "C:/Users/saman/AppData/Local/Arm/Packs/Keil/LPC1700_DFP/2.7.2/Device/Include/system_LPC17xx.h"
...
# 108 "C:/Users/saman/AppData/Local/Arm/Packs/Keil/LPC1700_DFP/2.7.2/Device/Include\\LPC17xx.h" 2
# 120 "C:/Users/saman/AppData/Local/Arm/Packs/Keil/LPC1700_DFP/2.7.2/Device/Include\\LPC17xx.h"
typedef struct
{
...
# 11 "Source/Src/lib_timer.c" 2
# 1 "./Source/Inc\\timer.h" 1
# 14 "./Source/Inc\\timer.h"
...
# 12 "Source/Src/lib_timer.c" 2
uint32_t tick=0;
void enable_timer( uint8_t timer_num )
{
  if ( timer_num == 0 )((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->TCR = 1;
 else if ( timer_num == 1 )((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->TCR = 1;
 else if ( timer_num == 2 )((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->TCR = 1;
 else if ( timer_num == 3 )((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->TCR = 1;
  return;
}
...
uint32_t read_timer( uint8_t timer_num )
{
  ...
  if ( timer_num == 0 ) return ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->TC;
 else if ( timer_num == 1 ) return ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->TC;
 else if ( timer_num == 2 ) return ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->TC;
 else if ( timer_num == 3 ) return ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->TC;
 return 0;
}
...
{
  if ( timer_num == 0 ) ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->TCR = 0;
 else if ( timer_num == 1 ) ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->TCR = 0;
 else if ( timer_num == 2 ) ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->TCR = 0;
 else if ( timer_num == 3 ) ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->TCR = 0;
  return;
}
...
// <i> 0 Feature disabled.
// </e>
 ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MCR = configuration;
// </h>
// <<< end of configuration section >>>
 ...
 ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->MCR = configuration;
 ...
 return (1);
  ...
  ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->MCR = configuration;
  __NVIC_EnableIRQ(TIMER2_IRQn);
  //__NVIC_SetPriority(TIMER2_IRQn, 5);
 return (1);
  }
  else if ( timer_num == 3 )
  {
  ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->MR0 = TimerInterval;
  ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->MCR = configuration;
  __NVIC_EnableIRQ(TIMER3_IRQn);
  //__NVIC_SetPriority(TIMER3_IRQn, 5);
 return (1);
  }
  return (0);
}
