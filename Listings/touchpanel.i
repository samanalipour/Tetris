# 1 "Source/Src/TouchPanel.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 379 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Source/Src/TouchPanel.c" 2
# 24 "Source/Src/TouchPanel.c"
# 1 "./Source/Inc\\GLCD.h" 1
# 26 "./Source/Inc\\GLCD.h"
...
# 250 "Source/Src/TouchPanel.c"
void TP_DrawPoint(uint16_t Xpos,uint16_t Ypos)
{
  LCD_SetPoint(Xpos,Ypos,0xFFFF);
}
# 264 "Source/Src/TouchPanel.c"
void DrawCross(uint16_t Xpos,uint16_t Ypos)
{
